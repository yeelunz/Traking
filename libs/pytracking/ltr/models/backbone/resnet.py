...
try:  # torchvision >= 0.14 removed model_urls from resnet
    from torchvision.models import resnet as _tv_resnet
    _MODEL_URLS = getattr(_tv_resnet, "model_urls", None)
except Exception:  # pragma: no cover - safeguard for unexpected torchvision layouts
    _MODEL_URLS = None

if not _MODEL_URLS:
    # Fallback to hardcoded URLs matching torchvision defaults.
    _MODEL_URLS = {
